...
const DuplicateProducts = () => {
  ...
  const handleUpdate = async (data: any) => {
    ...
    // console.log("inside update handle", updatedData);
    const res = await createGadgets(updatedData);
    if (res) {
  ...
  return (
    <div className="my-20 flex justify-center items-center">
      <div className="card w-96 bg-base-100 shadow-xl">
        <h1 className="text-center text-4xl font-bold">Duplicate and Edit </h1>
